...
export const Header: React.FC = () => {
  return (
    <header className="flex items-center justify-between border-b border-lines-light bg-white p-5 peer-[.w-72]/sidebar:pl-[19.5rem] dark:border-lines-dark dark:bg-dark-grey">
